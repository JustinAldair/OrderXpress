package com.example.orderxpress.Herramientas.Notas.Adapters;
...
import com.example.orderxpress.Herramientas.Notas.Click_Notas;
...
public class NotasListaAdapter extends RecyclerView.Adapter<NotasViewHolder>{
    ...
    private int getRandomColor(){
        ...
        CodigoColores.add(R.color.azul);
